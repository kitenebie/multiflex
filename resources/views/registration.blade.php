...
<main>
    ...
    <section class="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Membership</h2>
                    @if(session('success'))
                    ...
                    <form class="form-contact contact_form" action="{{ route('registration.store') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-3">
                                <label for="member_type" class="form-label fw-bold">Membership Type</label>
                                <select class="form-select border border-2 border-primary" name="member_type"
                                    id="member_type" required>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input class="form-control border border-2 border-primary" name="firstname"
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input class="form-control border border-2 border-primary" name="middlename"
                                    id="middlename" type="text" placeholder="Enter Middle Name">
                            </div>

                            <!-- Last Name -->
                            <div class="col-sm-6 mb-3">
                                <label for="lastname" class="form-label fw-bold">Last Name</label>
                                <input class="form-control border border-2 border-primary" name="lastname"
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-control border border-2 border-primary" name="confirmpassword"
...
<script>
    $(document).ready(function() {
        ...
        function checkPasswordStrength(password) {
            ...
            return strength >= 4; // At least 8 chars, lower, upper, number, special
        }
        ...
        // Update password field styling and error message
        $('#password').on('input', function() {
            ...
            // Also check confirm when password changes
            $('#confirmpassword').trigger('input');
        });

        // Update confirm password field styling and error message
