...
<head>
    ...
    <title>Subscription Approval Notification</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="message">
            <p>Hi {{ $user->name }},</p>
            <p>Congratulations! Your subscription has been approved and is now active.</p>
            ...
            <div class="details">
                ...
                @if($subscription->coach)
                    <p><strong>Assigned Coach:</strong> {{ $subscription->coach->name }}</p>
                @endif
        ...
        <div class="footer-text">
            <p>Welcome to our fitness program! You can now start your training sessions.</p>
        </div>
