<div class="pricing-section">
    ...
    <p class="pricing-subtitle">
        Choose an affordable fitness plan packed with top-tier training programs, expert coaching, and facilities to
    ...
    <div class="pricing-cards" style="--cards-count: {{ count($fitnessOffers) }}">
        @foreach ($fitnessOffers as $index => $offer)
            <div
                ...
                <p class="summary">
                    {{ $offer->description[0]['fitness_offered'] ?? 'A great plan for your fitness journey.' }}</p>
                <ul>
                    @forelse ($offer->description[0]['includes'] as $include)
                        <li>
                            <svg class="cfry" viewBox="0 0 20 20" fill="currentColor">
