    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Action::make('date_cutoff_info')
                ...
                ->modalContent(fn() => new HtmlString("Payslips are generated based on a monthly cutoff period, typically from the 1st to the last day of each month. Ensure that all work hours, and deductions are accurately recorded within this period to reflect in the payslip."))
                ->modalWidth('5xl')
